...
import { 
  Search, FileText, Calendar, CheckCircle, Clock, 
  LogOut, User, Star, MessageSquare, ThumbsUp, ThumbsDown,
  Download, Mail, Phone, MapPin, ArrowLeft, Send
} from 'lucide-react';
...
export function InterviewerPortal() {
  ...
  const [selectedTab, setSelectedTab] = useState<'assigned' | 'interviews' | 'submitted'>('assigned');
  ...
  const filteredCandidates = mockAssignedCandidates.filter(c => 
    ...
    <div className="h-screen flex bg-white">
      ...
      <div className="w-64 border-r border-neutral-200 flex flex-col">
        <div className="p-4 border-b border-neutral-200">
          <h1 className="text-[15px] font-semibold text-neutral-900">Interview Portal</h1>
          <p className="text-[11px] text-neutral-500 mt-0.5">Interviewer Dashboard</p>
        </div>
        ...
        <div className="p-3 border-t border-neutral-200">
          <div className="flex items-center gap-2 mb-3 p-2 bg-neutral-50 rounded">
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[12px] font-medium text-neutral-900 truncate">Rahul Verma</div>
          ...
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-[11px] text-neutral-500 mt-0.5">
                {selectedTab === 'assigned' && `${filteredCandidates.length} candidates assigned`}
            ...
            <div className="p-5">
                  ...
                  {filteredCandidates.map((candidate) => (
                    <tr key={candidate.id} className="border-b border-neutral-100 hover:bg-neutral-50">
                      <td className="px-4 py-2.5">
                        <span className="text-[12px] text-neutral-900 font-medium">{candidate.name}</span>
                      </td>
                      <td className="px-4 py-2.5 text-[12px] text-neutral-700">{candidate.role}</td>
                      <td className="px-4 py-2.5 text-[12px] text-neutral-700">{candidate.experience}</td>
                      <td className="px-4 py-2.5 text-[12px] text-neutral-700">{candidate.noticePeriod}</td>
                      <td className="px-4 py-2.5">
                        <span className={`inline-block px-2 py-0.5 rounded text-[10px] font-medium border ${
                          candidate.stage === 'Screening' ? 'bg-blue-50 text-blue-700 border-blue-200' :
                          candidate.stage === 'Technical' ? 'bg-amber-50 text-amber-700 border-amber-200' :
              ...
              {filteredCandidates.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <p className="text-[13px] text-neutral-600">No candidates assigned</p>
                  <p className="text-[11px] text-neutral-500 mt-1">Assigned candidates will appear here</p>
                </div>
              )}
            </div>
          )}
          ...
          {selectedTab === 'interviews' && (
            <div className="p-5">
              <div className="text-center py-12">
                ...
                <p className="text-[13px] text-neutral-600">No upcoming interviews</p>
                <p className="text-[11px] text-neutral-500 mt-1">Your interview schedule will appear here</p>
              </div>
            </div>
          )}
          ...
          {selectedTab === 'submitted' && (
            <div className="p-5">
              <div className="text-center py-12">
                ...
                <p className="text-[13px] text-neutral-600">No feedback submitted yet</p>
                <p className="text-[11px] text-neutral-500 mt-1">Completed feedback history will appear here</p>
              </div>
            </div>
          )}
        </div>
      ...
      <div className="border-b border-neutral-200 px-5 py-4">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div className="flex-1">
            ...
            <p className="text-[12px] text-neutral-600">{candidate.role} • {candidate.experience}</p>
          </div>
          <Button
            variant="outline"
            size="sm"
        ...
        <div className="max-w-5xl mx-auto p-6">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden">
                  <div className="px-4 py-3 bg-neutral-50 border-b border-neutral-200">
                    <div className="flex items-center justify-between">
                      <h3 className="text-[13px] font-semibold text-neutral-900">Resume</h3>
                  ...
                  <div className="p-4 max-h-96 overflow-auto bg-neutral-50">
                    <div className="bg-white border border-neutral-200 rounded p-6 text-[11px]">
                      <div className="text-center mb-4">
                        <h2 className="text-[16px] font-bold text-neutral-900">{candidate.name.toUpperCase()}</h2>
                        <p className="text-[12px] text-neutral-600 mt-1">{candidate.role}</p>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-neutral-700 leading-relaxed">
                            Experienced professional with {candidate.experience} of expertise in {candidate.role.toLowerCase()}.
                          </p>
                        </div>
                        <div>
                          <h3 className="text-[12px] font-semibold text-neutral-900 border-b border-neutral-200 pb-1 mb-2">
                          ...
                          <p className="text-neutral-700">{candidate.skills.join(', ')}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden">
                <div className="px-4 py-3 bg-neutral-50 border-b border-neutral-200">
                  <h3 className="text-[13px] font-semibold text-neutral-900">Candidate Summary</h3>
                </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-1.5 text-[12px]">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-neutral-900">{candidate.email}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Phone className="w-3.5 h-3.5 text-neutral-400" />
                        <span className="text-neutral-900">{candidate.phone}</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <MapPin className="w-3.5 h-3.5 text-neutral-400" />
                        <span className="text-neutral-900">{candidate.location}</span>
                      </div>
                    </div>
                  </div>

                  <div>
                    <h4 className="text-[11px] font-semibold text-neutral-600 mb-2">Professional Details</h4>
                    <div className="grid grid-cols-2 gap-3 text-[12px]">
                      <div className="p-2 bg-neutral-50 rounded border border-neutral-200">
                        <div className="text-neutral-500 mb-0.5">Experience</div>
                        <div className="text-neutral-900 font-medium">{candidate.experience}</div>
                      </div>
                      <div className="p-2 bg-neutral-50 rounded border border-neutral-200">
                        <div className="text-neutral-500 mb-0.5">Notice Period</div>
                        <div className="text-neutral-900 font-medium">{candidate.noticePeriod}</div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="space-y-6">
              <div className="bg-white border border-neutral-200 rounded-lg overflow-hidden">
                <div className="px-4 py-3 bg-neutral-50 border-b border-neutral-200">
                  <h3 className="text-[13px] font-semibold text-neutral-900">Interview Feedback Form</h3>
                  <p className="text-[11px] text-neutral-500 mt-0.5">Please provide detailed feedback on the candidate</p>
                </div>
                <div className="p-4 space-y-4">
                  {/* Technical Rating */}
                  <div>
                    <Label className="text-[11px] text-neutral-600 mb-2 block">Technical Rating (1-5) *</Label>
                    <div className="flex gap-2">
                      {[1, 2, 3, 4, 5].map((rating) => (
                        ...
                        >
                          <Star className={`w-4 h-4 mx-auto ${technicalRating >= rating ? 'fill-current' : ''}`} />
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    <Label className="text-[11px] text-neutral-600 mb-2 block">Communication Rating (1-5) *</Label>
                    <div className="flex gap-2">
                      {[1, 2, 3, 4, 5].map((rating) => (
                        <button
                          key={rating}
                        ...
                        >
                          <MessageSquare className={`w-4 h-4 mx-auto ${communicationRating >= rating ? 'fill-current' : ''}`} />
                        </button>
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    <Label className="text-[11px] text-neutral-600 mb-2 block">Problem Solving (1-5) *</Label>
                    <div className="flex gap-2">
                      {[1, 2, 3, 4, 5].map((rating) => (
                        <button
                          key={rating}
                  ...
                  {/* Strengths */}
                  <div>
                    <Label className="text-[11px] text-neutral-600 mb-2 block">Strengths *</Label>
                    <Textarea
                      value={strengths}
                  ...
                  {/* Weaknesses */}
                  <div>
                    <Label className="text-[11px] text-neutral-600 mb-2 block">Weaknesses / Areas for Improvement *</Label>
                    <Textarea
                      value={weaknesses}
                  ...
                  {/* Additional Notes */}
                  <div>
                    <Label className="text-[11px] text-neutral-600 mb-2 block">Additional Notes (Optional)</Label>
                    <Textarea
                  ...
                  {/* Recommendation */}
                  <div>
                    <Label className="text-[11px] text-neutral-600 mb-2 block">Recommendation *</Label>
                  ...
                  {recommendation === 'Reject' && (
                    <div className="p-3 bg-red-50 border border-red-200 rounded">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-[12px] text-red-900 font-medium">Rejection Notice</p>
                          <p className="text-[11px] text-red-700 mt-1">
                            A rejection email will be automatically sent to the candidate upon submission.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  {recommendation === 'Move Forward' && (
                    <div className="p-3 bg-emerald-50 border border-emerald-200 rounded">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <p className="text-[12px] text-emerald-900 font-medium">Next Stage</p>
                          <p className="text-[11px] text-emerald-700 mt-1">
                            The candidate will be moved to the next stage of the hiring process.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="pt-2">
                    <Button
                      ...
                      onClick={onSubmit}
                      disabled={!technicalRating || !communicationRating || !problemSolvingRating || !strengths || !weaknesses || !recommendation}
                    >
