...
export function Login() {
  ...
  const { setAuthFromLogin } = useAuthContext();
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setAuthFromLogin(user, finalAccessToken);
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white border border-border rounded-lg p-8">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              <Label htmlFor="role" className="text-[13px] text-foreground mb-2 block">
                Login as
              </Label>
              <Select value={role} onValueChange={(value: "admin" | "interviewer") => setRole(value)}>
            ...
            <div>
              <Label htmlFor="password" className="text-[13px] text-foreground mb-2 block">
                Password
              </Label>
              <Input
                id="password"
          ...
          <div className="mt-6 pt-6 border-t border-border">
            <p className="text-[12px] text-muted-foreground text-center">
              For support, contact{" "}
              <a href="mailto:support@metaphi.com" className="text-primary hover:underline">
                support@metaphi.com
              </a>
            </p>
          </div>
