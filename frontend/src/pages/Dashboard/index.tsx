...
export function Dashboard() {
	...
	const screeningPending = candidates.filter(
		(c) => c.stage === "Screening",
	).length;
	...
	const recentActivity = [
		{
			id: 1,
			type: "offer",
			text: "Offer sent to Anjali Verma for UI/UX Designer",
			time: "2 hours ago",
		},
		{
			id: 2,
			type: "technical",
			text: "Priya Sharma moved to Technical round",
			time: "4 hours ago",
		},
		{
			id: 3,
			type: "screening",
			text: "Rahul Mehta completed screening",
			time: "5 hours ago",
		},
		{
			id: 4,
			type: "new",
			text: "New candidate added: Arjun Singh",
			time: "6 hours ago",
		},
		{
			id: 5,
			type: "rejected",
			text: "Vikram Patel marked as rejected",
			time: "1 day ago",
		},
	];
	...
	const metrics = [
		...
		},
		{
			...
			value: screeningPending,
			icon: Clock,
			color: "text-blue-600",
			bg: "bg-blue-50",
		},
		{
			label: "Technical Pending",
							...
							<table className='w-full'>
								...
								<tbody>
									{roleProgress.map((role, index) => (
										...
										>
											<td className='py-2.5 text-[13px] text-foreground'>
												{role.role}
											</td>
											<td className='py-2.5 text-[13px] text-foreground'>
												{role.required}
